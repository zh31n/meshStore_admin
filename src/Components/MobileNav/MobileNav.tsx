    ...
    <div className={s.mob_nav} >
      <div className="container" style={{background:'black'}}>
        <div className={s.nav_i}>
          <Link
            to={"/profile/today"}
            className={currentLink == "today" ? s.nav_item_active : s.nav_item}
            onClick={() => {
          ...
          <Link
            to={"/profile/calendar"}
            className={
              currentLink == "calendar" ? s.nav_item_active : s.nav_item
            }
            onClick={() => {
          ...
          <Link
            className={
              currentLink == "clients" ? s.nav_item_active : s.nav_item
            }
            onClick={() => {
          ...
          <Link
            to={"/profile/settings"}
            className={
              currentLink == "settings" ? s.nav_item_active : s.nav_item
            }
            onClick={() => {
