            ...
            <div className={s.header}>
                <div className='container'>
                    <div className={s.header_inner}>
                        ...
                        <div className={s.nav}>
                            <Link to={'/profile/today'} className={s.navItem} style={{color: 'white'}}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                     fill="none">
                                    <g clip-path="url(#clip0_100_1712)">
                                        <path className={s.hovv}
                                        ...
                                        <path className={s.hovv} d="M4 13C4.28668 15.0682 5.36155 16.9457 7 18.24" stroke="white"
                                        ...
                                        <path className={s.hovv}
                                            ...
                                            stroke="white" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round"/>
                                        <path className={s.hovv} d="M20 15V21" stroke="white" stroke-width="2" stroke-linecap="round"
                                              stroke-linejoin="round"/>
                                    </g>
                                    <defs>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="24" viewBox="0 0 26 24"
                                    ...
                                    <g clip-path="url(#clip0_100_1715)">
                                        <path className={s.hovv}
                                            ...
                                            stroke-linejoin="round"/>
                                        <path className={s.hovv} d="M16.8887 3V7" stroke="#838383" stroke-width="2" stroke-linecap="round"
                                              stroke-linejoin="round"/>
                                        <path d="M8.44434 3V7" className={s.hovv} stroke="#838383" stroke-width="2" stroke-linecap="round"
                                              stroke-linejoin="round"/>
                                        <path d="M4.22266 11H21.1115" className={s.hovv} stroke="#838383" stroke-width="2"
                                              stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M11.6113 15H12.6669" className={s.hovv} stroke="#838383" stroke-width="2"
                                              stroke-linecap="round" className={s.hovv} stroke-linejoin="round"/>
                                        <path d="M12.667 15V18" className={s.hovv} stroke="#838383" stroke-width="2" stroke-linecap="round"
                                              stroke-linejoin="round"/>
                                    </g>
                                    <defs>
