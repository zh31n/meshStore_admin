            ...
            <div className={s.header}>
                <div className='container'>
                    <div className={s.header_inner}>
                        ...
                        <div className={s.nav}>
                            <Link className={s.navItem} style={{color: 'white'}}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                    ...
                                    <g clip-path="url(#clip0_100_1712)">
                                        ...
                                        <path d="M4 13C4.28668 15.0682 5.36155 16.9457 7 18.24" stroke="white"
                                        ...
                                        <path
                                            ...
                                            stroke="white" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round"/>
                                        <path d="M20 15V21" stroke="white" stroke-width="2" stroke-linecap="round"
                                              stroke-linejoin="round"/>
                                    </g>
                                    <defs>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="24" viewBox="0 0 26 24"
                                    ...
                                    <g clip-path="url(#clip0_100_1715)">
                                        <path
                                            ...
                                            stroke-linejoin="round"/>
                                        <path d="M16.8887 3V7" stroke="#838383" stroke-width="2" stroke-linecap="round"
                                              stroke-linejoin="round"/>
                                        <path d="M8.44434 3V7" stroke="#838383" stroke-width="2" stroke-linecap="round"
                                              stroke-linejoin="round"/>
                                        <path d="M4.22266 11H21.1115" stroke="#838383" stroke-width="2"
                                              stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M11.6113 15H12.6669" stroke="#838383" stroke-width="2"
                                              stroke-linecap="round" stroke-linejoin="round"/>
                                        <path d="M12.667 15V18" stroke="#838383" stroke-width="2" stroke-linecap="round"
                                              stroke-linejoin="round"/>
                                    </g>
                                    <defs>
