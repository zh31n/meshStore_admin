...
const Calendar = () => {
    return (
        <div className={s.cont}>
            <div className={s.cont_day}>
                <div className={s.header}>
                    <div className={s.info}>
                        <div className={s.count}>2 события</div>
                        <div className={s.day}>Пт, 8 июля</div>
                    </div>
                </div>
                <div className={s.calend_i}>
                    <EventItemC length={'15'} type={'мин'} name={'Название события'} time={'14:15 - 15:00'}/>
                    <EventItemC length={'15'} type={'мин'} name={'Название события'} time={'14:15 - 15:00'}/>
                    <EventItemC length={'15'} type={'мин'} name={'Название события'} time={'14:15 - 15:00'}/>
                    <EventItemC length={'15'} type={'мин'} name={'Название события'} time={'14:15 - 15:00'}/>
                </div>
                <Link className={s.btn}>+</Link>
            </div>
            <div className={s.cont_day}>
                <div className={s.header}>
                    <div className={s.info}>
