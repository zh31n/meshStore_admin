...
const ChangeEvent = ({ setNewArr }: any) => {
  ...
  return (
    <div className={s.event_container}>
      ...
      <div className={s.sup}>
        Прежде всего, высокотехнологичная концепция общественного уклада создаёт
        предпосылки для поэтапного и последовательного развития общества!
      </div>
      ...
      <div className={s.btn_red} onClick={hadnleDelete}>
        Удалить
      </div>
